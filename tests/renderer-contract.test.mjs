...
assert.match(source, /segmentCollisionWithResidual\(b, segment, routeGravity, dt\)/);
assert.match(source, /segmentCollisionWithResidual\(b, \{ \.\.\.state\.layout\.gate, material: 'copper' \}, routeGravity, dt\)/);
assert.match(source, /segmentCollisionWithResidual\(b, \{ \.\.\.guard, width: 12, material: 'steel' \}, routeGravity, dt\)/);
