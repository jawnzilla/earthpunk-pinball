...
assert.match(source, /collectRuntimeContactCandidates\(\{ circle: primaryCircleCandidate, segment: preStaticSegmentCandidate, flipper: preSelectedFlipperCandidate \}\)/);
