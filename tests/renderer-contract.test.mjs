...
assert.match(source, /if \(runtimeContactWinner\?\.kind === 'segment' && preStaticSegmentCandidate\) segmentCollisionWithResidual\(b, preStaticSegmentCandidate\.segment, routeGravity, dt\)/);
